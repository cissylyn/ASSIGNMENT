...
dfs_path = depth_first_search(g, start, target)
...
bfs_path = breadth_first_search(g, start, target)
...
ucs_path = uniform_cost_search(g, start, target)
...
greedy_path = greedy_search(g, start, target, h)
...
a_star_path = a_star_search(g, start, target, h)
