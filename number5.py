...
goal_state = 'G'
dfs_result = depth_first_search_tree(graph_data, 'S', goal_state)
bfs_result = breadth_first_search_tree(graph_data, 'S', goal_state)
ucs_result = uniform_cost_search_tree(graph_data, 'S', goal_state)
greedy_result = greedy_search_tree(graph_data, 'S', goal_state)
a_star_result = a_star_search_tree(graph_data, 'S', goal_state)
